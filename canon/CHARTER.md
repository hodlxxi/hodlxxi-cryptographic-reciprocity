...
Every Canon chapter should distinguish:

1. Observation: what exists or can be seen.
2. Theory: what mechanism might explain it.
3. Counterargument: why the theory might fail.
4. Historical analogies: where similar patterns appeared before.
5. Implications for HODLXXI: what should be encoded, visible, private, reversible, forgiven, permanent, or impossible.
